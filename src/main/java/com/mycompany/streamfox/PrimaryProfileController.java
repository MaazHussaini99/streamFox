...
public class PrimaryProfileController implements Initializable {
    ...
    double tempYoutubeDailyWatchTime;
    double tempYoutubeWeeklyWatchTime;
    double tempTwitchDailyWatchTime;
    double tempTwitchWeeklyWatchTime;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tempYoutubeDailyWatchTime = (double) userData.getYTDailyWatchDataMap().get(dateString);
        tempYoutubeWeeklyWatchTime = (double) userData.getYTDailyWatchDataMap().get("WeeklyWatchTime");
        tempTwitchDailyWatchTime = (double) userData.getTwitchDailyWatchDataMap().get(dateString);
        tempTwitchWeeklyWatchTime = (double) userData.getTwitchDailyWatchDataMap().get("WeeklyWatchTime");

        tempDailyWatchTime = tempYoutubeDailyWatchTime + tempTwitchDailyWatchTime;
        tempWeeklyWatchTime = tempYoutubeWeeklyWatchTime + tempTwitchWeeklyWatchTime;
        ...
        double mondayYTWatchtime = (double) userData.getYTDailyWatchDataMap().get("mondayWatchTime");
        if (mondayYTWatchtime == 0.001) {
            mondayYTWatchtime = 0;
        }
        ...
        youtubeSeries.getData().add(new XYChart.Data("Thursday", fixWatchTime(userData.getYTDailyWatchDataMap().get("thursdayWatchTime"))));
        youtubeSeries.getData().add(new XYChart.Data("Friday", fixWatchTime(userData.getYTDailyWatchDataMap().get("fridayWatchTime"))));
        youtubeSeries.getData().add(new XYChart.Data("Saturday", fixWatchTime(userData.getYTDailyWatchDataMap().get("saturdayWatchTime"))));
        youtubeSeries.getData().add(new XYChart.Data("Sunday", fixWatchTime(userData.getYTDailyWatchDataMap().get("sundayWatchTime"))));

        twitchSeries = new XYChart.Series();
        twitchSeries.setName("Twitch");
        twitchSeries.getData().add(new XYChart.Data("Monday", fixWatchTime(userData.getTwitchDailyWatchDataMap().get("mondayWatchTime"))));
        twitchSeries.getData().add(new XYChart.Data("Tuesday", fixWatchTime(userData.getTwitchDailyWatchDataMap().get("tuesdayWatchTime"))));
        twitchSeries.getData().add(new XYChart.Data("Wednesday", fixWatchTime(userData.getTwitchDailyWatchDataMap().get("wednesdayWatchTime"))));
        twitchSeries.getData().add(new XYChart.Data("Thursday", fixWatchTime(userData.getTwitchDailyWatchDataMap().get("thursdayWatchTime"))));
        twitchSeries.getData().add(new XYChart.Data("Friday", fixWatchTime(userData.getTwitchDailyWatchDataMap().get("fridayWatchTime"))));
        twitchSeries.getData().add(new XYChart.Data("Saturday", fixWatchTime(userData.getTwitchDailyWatchDataMap().get("saturdayWatchTime"))));
        twitchSeries.getData().add(new XYChart.Data("Sunday", fixWatchTime(userData.getTwitchDailyWatchDataMap().get("sundayWatchTime"))));
...
//        }
    ...
    private double fixWatchTime(Object watchTime) {
        double value = (double) watchTime;
        if (value == 0.001) {
            value = 0;
        }
        return value;
